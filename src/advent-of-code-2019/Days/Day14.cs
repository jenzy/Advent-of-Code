...
so only whole integer multiples of these quantities can be used. (It's okay to have leftover chemicals when you're done, though.)
...
they indicate that you can produce as much of chemical A as you want (in increments of 10 units, each 10 costing 10 ORE)
...
Given 1 trillion ORE, what is the maximum amount of FUEL you can produce?
    ...
    {
        public override object Part1() => GetRequiredOre(Parse(Input), Chemical.Fuel(1));
        ...
        private class Chemical
        {
            ...
            {
                var spl = chemical.Split(' ');
                this.Quantity = int.Parse(spl[0]);
                this.Name = spl[1];
            }
            ...
            public static Chemical Fuel(long quantity) => new Chemical("FUEL", quantity);
        }

        private class Reaction
        {
            public Reaction(Chemical output, IEnumerable<Chemical> inputs)
            {
                this.Output = output;
