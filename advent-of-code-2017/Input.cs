namespace AdventOfCode2017
{
    ...
    {
        public const string Day1 = @"";

        public const string Day2 = @"1208	412	743	57	1097	53	71	1029	719	133	258	69	1104	373	367	365
...
525	1263	146	954	188	232	1019	918	268	172	1196	1091	1128	234	650	420";
        ...
        public const string Day3 = @"277678";
...
-297";
        ...
        public const string Day6 = @"14	0	15	12	11	11	3	5	1	6	8	4	9	1	8	4";

        public const string Day7 = @"uglvj (99) -> ymfjt, gkpgf
vvwrg (51)
qrpgt (5)
qhqbqj (55)
taxdaf (23)
...
gwgnf (57) -> wbntjyi, ifmgil, zeximw";
        ...
        public const string Day8 = @"g dec 231 if bfx > -10
k dec -567 if wfk == 0
jq inc 880 if a < 2
sh inc -828 if nkr < -5
w inc 595 if nkr > -10
...
afu dec 990 if wfk < -1202";
        ...
        public const string Day12 = @"0 <-> 950, 1039
1 <-> 317, 904, 923
2 <-> 2
3 <-> 870
4 <-> 361
...
jgz a -19";
 ...
 +-----------------+                     +-+ +-------------------+       +---+                   +-----------------------------------+                                                     +---+         
        ...
        public const string Day20 = @"p=<1199,-2918,1457>, v=<-13,115,-8>, a=<-7,8,-10>
...
..###.###.##.#.###....#.#";
        ...
        public const string Day23 = @"set b 84
set c b
jnz a 2
jnz 1 5
mul b 100
...
jnz 1 -23";
        ...
        public const string Day24 = @"50/41
19/43
17/50
32/32
22/44
...
2/6";
        ...
        public const string Day25 = @"Begin in state A.
